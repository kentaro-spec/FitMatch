...
export default function PostChatBar({locked, postMessage}) {
		...
		<div className=" flex justify-center">
			<div className="text-center bottom-5 fixed">
				<div className="inline-block relative">
					...
					<button onClick={handleClick} className="absolute inset-y-0 right-0 flex items-center px-2 text-gray-700">
